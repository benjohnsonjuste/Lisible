  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white rounded-xl shadow mt-6 space-y-6">
      ...
      <div className="flex gap-4 pt-4 border-t items-center">
        {/* CORRECTION 1 : Ajout de type="button" pour éviter le rechargement */}
        <button onClick={handleLike} type="button" className="flex items-center gap-2 transition"> 
          <Heart
            size={24}
      ...
      <div className="pt-4 border-t">
        ...
        <div className="mt-3 flex flex-col gap-2">
          ...
          />
          {/* CORRECTION 2 : Ajout de type="button" pour éviter le rechargement */}
          <button
