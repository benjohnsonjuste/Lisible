    ...
    try {
      ...
      const res = await fetch("/api/texts", {
        ...
        body: JSON.stringify({
          ...
          category: "Battle Poétique" // Synchronisé avec l'API index
        })
      });
        ...
        <form onSubmit={handleSubmit} className="relative z-10 space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div 
              ...
              className={`p-8 rounded-[2.5rem] border-2 transition-all cursor-pointer flex flex-col items-center justify-center text-center ${isBattlePoetic ? 'border-teal-500 bg-teal-500/10' : 'border-white/5 opacity-40 hover:opacity-60'}`}
            >
          ...
          {/* AJOUT DE L'ILLUSTRATION POUR LE DUEL */}
