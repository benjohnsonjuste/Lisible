...
export default function Home() {
  return (
    <div className="space-y-16 pb-12 animate-in fade-in duration-1000 font-sans">
      ...
      {/* Section Label */}
      <section className="rounded-[3.5rem] bg-teal-50 p-12 text-center space-y-8 border border-teal-100/50 mx-2">
        <div className="space-y-2">
...
// ISR : La page est générée une fois sur le serveur et mise à jour toutes les heures si nécessaire
export async function getStaticProps() {
  return {
    props: {},
    revalidate: 3600 // Mise à jour du cache toutes les heures
  };
}
