...
export const CGU_VERSION = "2026-09-25-v2";
...
Le certificat émis scelle l'horodatage de ce dépôt : il témoigne de l'antériorité de l'œuvre telle que déposée. Lisible conserve dans son archive l'empreinte cryptographique SHA-256 du texte ou du document et la date exacte du dépôt.
...
Le scellé est définitif : le certificat porte sur l'œuvre telle que déposée. Toute modification ultérieure de l'œuvre nécessitera un nouveau scellé.`;
