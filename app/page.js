    ...
    <div className="bg-white dark:bg-slate-950 font-sans selection:bg-teal-100 transition-colors duration-300">
      ...
      <main className="pt-24 space-y-16 pb-12 animate-in fade-in duration-1000">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 px-4">
          {/* Lecteurs */}
          <div className="group bg-white dark:bg-slate-900 p-10 space-y-8 rounded-[3rem] border-none ring-1 ring-slate-100 dark:ring-white/5 shadow-xl shadow-slate-200/50 hover:shadow-2xl transition-all duration-500">
            <div className="w-16 h-16 bg-teal-50 dark:bg-teal-900/20 text-teal-600 rounded-[1.5rem] flex items-center justify-center group-hover:bg-teal-600 group-hover:text-white transition-colors duration-500">
              <BookOpen size={32} />
            </div>
            ...
            <Link href="/bibliotheque" className="flex items-center justify-between w-full bg-slate-50 dark:bg-white/5 text-slate-900 dark:text-white px-8 py-5 rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-teal-600 hover:text-white transition-all shadow-sm">
        ...
        <section className="rounded-[3.5rem] bg-teal-50 dark:bg-teal-900/10 p-12 text-center space-y-8 border border-teal-100/50 dark:border-teal-900/20 mx-4">
          <div className="space-y-2">
          ...
          <p className="text-slate-700 dark:text-slate-300 text-xl md:text-2xl font-serif italic max-w-3xl mx-auto leading-relaxed">
