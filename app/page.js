...
export default function Home() {
  return (
    // Suppression de pb-12 pour éviter un trou béant avant le vrai Footer global
    <div className="space-y-16 animate-in fade-in duration-1000 font-sans px-2 md:px-4">
        ...
        <div className="group bg-slate-900 p-10 space-y-8 rounded-[3rem] border-none text-white shadow-xl shadow-slate-900/20 hover:shadow-2xl transition-all duration-500">
          ...
          <div className="space-y-4">
            ...
            <p className="text-slate-300 font-medium leading-relaxed">
              Monétisez vos écrits dès <span className="text-teal-400 font-black">250 abonnés</span>.
            </p>
          </div>
      ...
      {/* Section Label */}
      <section className="rounded-[3.5rem] bg-teal-50 p-12 text-center space-y-8 border border-teal-100/50 mb-12">
        <div className="space-y-2">
        ...
        <p className="text-slate-700 text-xl md:text-2xl font-serif italic max-w-3xl mx-auto leading-relaxed">
          "Fondé par <span className="font-black text-slate-900 not-italic">Ben Johnson Juste</span>..."
        </p>
      </section>

      {/* Note : Le Footer global est appelé par layout.js, pas besoin de le remettre ici */}
    </div>
  );
}
