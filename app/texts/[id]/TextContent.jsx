...
const TextContent = ({ id }) => {
  ...
  const loadContent = useCallback(async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        const viewedTexts = JSON.parse(
          localStorage.getItem("lisible_views") || "[]"
        );
        ...
        const author = allUsers.find(
          u =>
            ...
            (result.content.authorEmail || "").toLowerCase().trim()
        );
  ...
  useEffect(() => {
    ...
    const likedTexts = JSON.parse(
      localStorage.getItem("lisible_likes") || "[]"
    );
  ...
  const isBattle =
    ...
    ].includes(data.genre || data.category);
