      ...
      <main className="max-w-3xl mx-auto px-6 pt-40 pb-48">
        <header className={`mb-20 space-y-8 transition-all ${isFocusMode ? 'opacity-40' : ''}`}>
          <div className="flex gap-4 items-center">
            {(text.category === "Battle Poétique" || text.category === "Duel Des Nouvelles") ? (
              <span className="px-5 py-2 bg-blue-700 text-white rounded-full text-[9px] font-black uppercase tracking-widest animate-pulse">
                {text.category}
              </span>
            ) : (
