  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-emerald-500/30 selection:text-emerald-300 overflow-x-hidden">
      ...
      <header className="relative max-w-5xl mx-auto pt-20 pb-16 px-6 text-center space-y-6">
        ...
        <p className="text-slate-400 text-base md:text-xl max-w-2xl mx-auto font-normal leading-relaxed">Soumettez votre manuscrit à notre moteur d'audit macro-stylistique. Évaluez instantanément votre vélocité narrative, votre signature lexicale et votre compatibilité avec les grands comités.</p>
      ...
      <main className="max-w-6xl mx-auto px-4 md:px-6 space-y-24 pb-24">
        ...
        <section id="features" className="scroll-mt-24 space-y-12">
          <div className="text-center space-y-3">
            <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-slate-100">Une architecture d'analyse standard.</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-slate-900/50 border border-slate-900 p-6 rounded-2xl space-y-4">
              ...
              <p className="text-xs text-slate-400 leading-relaxed">Détection en temps réel des tics de langage, de la densité adverbiale et du rythme harmonique de vos paragraphes.</p>
            </div>
            <div className="bg-slate-900/50 border border-slate-900 p-6 rounded-2xl space-y-4">
            ...
            <div className="bg-slate-900/50 border border-slate-900 p-6 rounded-2xl space-y-4">
              ...
              <h3 className="font-semibold text-slate-200">Sécurité maximale</h3>
