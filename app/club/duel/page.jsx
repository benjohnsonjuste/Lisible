...
export default function DuelPage() {
  ...
  if (loading) return (
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center">
      ...
      <span className="text-white text-[10px] tracking-widest uppercase font-black">Initialisation...</span>
    </div>
  );
  ...
  // Phase ACTIVE : On affiche l'arène et une publicité en dessous
    ...
    <div className="min-h-screen bg-[#050505] text-white flex flex-col items-center justify-center p-6 text-center">
       ...
       <div className="flex items-center gap-3 bg-white/5 border border-white/10 px-8 py-4 rounded-full mb-12 backdrop-blur-md">
          ...
          <span className="text-[10px] font-black uppercase tracking-[0.3em]">
            {phase === "finished" ? "Rendez-vous au prochain défi" : "Ouverture de l'arène ce dimanche"}
          </span>
       </div>

       {/* PUBLICITÉ : Très efficace ici pendant l'attente */}
       <div className="w-full max-w-2xl mb-12">
          <InTextAd />
       </div>

       <p className="max-w-md text-slate-500 text-xs leading-relaxed italic opacity-60 uppercase tracking-widest">
         "Le silence avant la tempête est le moment où les plumes s'aiguisent."
       </p>
