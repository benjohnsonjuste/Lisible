...
import { 
  Play, Pause, ChevronLeft, Calendar, User, Clock, Share2, 
  Headphones, Volume2, Download, Eye, Loader2, Gift, X 
} from 'lucide-react';
          ...
          <div className="p-8 md:p-12">
            ...
            <div className="mb-10">
              <button 
                ...
                className="w-full flex items-center justify-between p-4 bg-slate-50 border border-slate-100 rounded-2xl hover:border-teal-200 transition-all group text-left"
              >
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-white shadow-sm rounded-xl flex items-center justify-center text-teal-600 group-hover:bg-teal-600 group-hover:text-white transition-colors">
                    <Gift size={20} />
                  </div>
                  <span className="text-[10px] font-black uppercase tracking-widest text-slate-600">Soutenir l'épisode avec un cadeau</span>
                </div>
