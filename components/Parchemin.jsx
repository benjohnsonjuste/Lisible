...
/**
 * Composant PARCHEMIN
 * Gère la certification de lecture et la génération du PDF d'authentification.
 */
export default function Parchemin({ 
  wordCount, 
  fileName, 
  userEmail, 
  onValidated, 
  ...
  const generateCertificate = async () => {
    try {
      const [{ default: confetti }, { default: jsPDF }] = await Promise.all([
      ...
      const dateInvocation = new Date().toLocaleDateString('fr-FR', {
        day: 'numeric',
        month: 'long',
        year: 'numeric'
      });
      ...
      doc.setFontSize(80);
      doc.text("LISIBLE", 148.5, 115, { align: "center" });
      ...
      doc.text(`ÉMIS LE ${dateInvocation.toUpperCase()} • ARCHIVE OFFICIELLE`, 148.5, 65, { align: "center" });
  ...
  return (
    <div className="my-32 flex flex-col items-center gap-10 animate-in fade-in zoom-in duration-1000">
      ...
      <div className="flex flex-col items-center gap-8">
        ...
        {/* Bouton de téléchargement du Parchemin */}
        <div className="relative group">
          <button 
