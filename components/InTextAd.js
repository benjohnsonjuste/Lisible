...
export function InTextAd() {
  ...
  return (
    <div className="my-12 animate-in fade-in zoom-in duration-1000">
      <div className="max-w-xl mx-auto bg-slate-900 dark:bg-black/40 backdrop-blur-2xl border border-slate-800 dark:border-white/10 p-3 rounded-[2.5rem] shadow-2xl flex flex-col gap-3">
        ...
        <div className="bg-white/5 dark:bg-white/5 rounded-[1.8rem] overflow-hidden min-h-[150px] flex items-center justify-center relative border border-white/5">
