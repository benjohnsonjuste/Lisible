...
export default function TextPublishingForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        content,
        genre,
        authorName: "Auteur inconnu", // tu peux remplacer par user.displayName si Auth
        authorEmail: "",
        imageBase64,
        imageName,
      };
  ...
  return (
    ...
    >
      ...
      {/* Image */}
      <div>
        <label className="block text-sm font-medium mb-1">Image d'illustration (optionnel)</label>
        <input
          type="file"
          accept="image/*"
